		...
		<div class="container">
			...
			<div class="nav navbar-nav navbar-right social-icons wow fadeInRight animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInRight;">
					<ul>
						...
						<li><a href="index.html#" class="pin"> </a></li>
						<li><a href="index.html#" class="in"> </a></li>
						<li><a href="index.html#" class="be"> </a></li>
						
						<li><a href="index.html#" class="vimeo"> </a></li>
					</ul>
				</div>
			...
			<div class="grid_3 grid_5">
				<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
					<ul id="myTab" class="nav nav-tabs" role="tablist">
						<li role="presentation" class="active"><a href="index.html#expeditions" id="expeditions-tab" role="tab" data-toggle="tab" aria-controls="expeditions" aria-expanded="true">FASHION</a></li>
						<li role="presentation" class=""><a href="index.html#safari" role="tab" id="safari-tab" data-toggle="tab" aria-controls="safari">TRAVEL</a></li>
						<li role="presentation" class=""><a href="index.html#trekking" role="tab" id="trekking-tab" data-toggle="tab" aria-controls="trekking">MUSIC</a></li>
					</ul>
			...
			<!-- technology-top -->
			 ...
			 <div class="tc-ch wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
					...
					<h6>BY <a href="singlepage.html">ADAM ROSE </a>JULY 10 2016.</h6>
						...
						<div class="soci">
							<ul>
								<li class="hvr-rectangle-out"><a class="fb" href="index.html#"></a></li>
								<li class="hvr-rectangle-out"><a class="twit" href="index.html#"></a></li>
								<li class="hvr-rectangle-out"><a class="goog" href="index.html#"></a></li>
								<li class="hvr-rectangle-out"><a class="pin" href="index.html#"></a></li>
								<li class="hvr-rectangle-out"><a class="drib" href="index.html#"></a></li>
							</ul>
						</div>
						<div class="clearfix"></div>
			</div>
